...
/*****************************************************************
 *
 * AddMultipoleLJ calculates the 1/r^6 multipole expansion of a
 * particle of weight b_lj, at location x,y,z relative to the
 * origin. The result is accumulated into the blank multipole
 * expansion array M. The array size is p.
 *
 */
...
/*****************************************************************
 *
 * M2M_LJ translates a Lennard-Jones multipole expansion M1 to another
 * expansion M2, both size p, along the vector x,y,z
 *
 */
...
/*****************************************************************
 *
 * M2L_LJ converts a Lennard-Jones multipole expansion M in to a local 
 * expansion L, shifting the original expansion along the vector x, y, z. 
...
/*****************************************************************
 *
 * L2L_LJ translates a local expansion L1 to another local expansion L2,
 * both of size p, along vector x, y, z
 *
 */
...
/*****************************************************************
 *
 * Force_LJ computes the Lennard-Jones force and potential on the
 * particle with charge q at position vector pv, due to the local
 * expansion L of size p.
 *
 * The results are returned as a potential, potp, and force vector, fv.
 *
 */
