...
/****************************************************************
 *
 * Force_C_Y computes the Coulomb force and potential on the particle with
 * charge q at position x, y, z, due to the local expansion L of size p. The
 * results are put in the array result in the following order: pot., fx, fy,
 * fz.
 *
 * note: this is the old version that used the Ynm matrix.  It has been
 * replaced by the more recent G/F form of the equation.
 *
 */
...
/****************************************************************
 *
 *  ForceM_C computes the Coulomb force and potential on the
 *  particle with charge q at position x, y, z, due to the Multipole
 *  expansion Min of size p.
 *
 */
...
/****************************************************************
 *
 *  shift a remote multipole into a local expansion, using the
 *  transfer matrix and FFT enhancements.
 *
 */
...
/****************************************************************
 *
 * Fourier series components of angle b out to p+1 (0->p) terms
 *
 */
