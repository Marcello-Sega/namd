...
static char rcsid[] = "$Id: dpmta_slave.c,v 1.3 1997/09/29 23:58:38 jim Exp $";

/*
 * revision history:
 *
 * $Log: dpmta_slave.c,v $
 * Revision 1.3  1997/09/29 23:58:38  jim
...
main()
{
   ...
   */
   ...
   /****************************************************************
   *
   *  allocate cell table and initialize interaction lists
   *
   */
   ...
   *  more particles.
   *
   *  note that we depend on the master process to kill up off when
   ...
   */
   ...
   while (TRUE) {
	 ...
	 Make_Hlist();
         ...
         /*
         *  coompute and collect inverse interaction lists from
         *  other slaves and place in IIlist
         */
