...
static char rcsid[] = "$Id: dpmta_slvmkhl.c,v 1.1 1997/09/05 19:42:04 jim Exp $";

/*
*  revision history:
* 
*  $Log: dpmta_slvmkhl.c,v $
*  Revision 1.1  1997/09/05 19:42:04  jim
...
void Compute_Hlist( int level )
{
   ...
   clen.x = (Dpmta_CellLength.x / Dpmta_MaxCellLen) / (double)(1 << level);
   clen.y = (Dpmta_CellLength.y / Dpmta_MaxCellLen) / (double)(1 << level);
   clen.z = (Dpmta_CellLength.z / Dpmta_MaxCellLen) / (double)(1 << level);
#else
   scaledv1.x = (Dpmta_PVector1.x / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv1.y = (Dpmta_PVector1.y / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv1.z = (Dpmta_PVector1.z / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv2.x = (Dpmta_PVector2.x / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv2.y = (Dpmta_PVector2.y / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv2.z = (Dpmta_PVector2.z / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv3.x = (Dpmta_PVector3.x / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv3.y = (Dpmta_PVector3.y / Dpmta_MaxCellLen) / (double)(1 << level);
   scaledv3.z = (Dpmta_PVector3.z / Dpmta_MaxCellLen) / (double)(1 << level);
#endif
