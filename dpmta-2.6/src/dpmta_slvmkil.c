...
static char rcsid[] = "$Id: dpmta_slvmkil.c,v 1.1 1997/09/05 19:42:05 jim Exp $";

/*
*  revision history:
* 
*  $Log: dpmta_slvmkil.c,v $
*  Revision 1.1  1997/09/05 19:42:05  jim
...
void Make_Ilist()
{
   ...
   int imask;                /* bitmask used to build index */
   ...
   int *tmp_sort;            /* temp array used for sorting */
   ...
   */
   ...
   scaledlen.x = Dpmta_CellLength.x / Dpmta_MaxCellLen;
   scaledlen.y = Dpmta_CellLength.y / Dpmta_MaxCellLen;
   scaledlen.z = Dpmta_CellLength.z / Dpmta_MaxCellLen;
...
void Make_Ilist()
{
   ...
   */
   ...
   scaledlen.x = Dpmta_PV1Mag / Dpmta_MaxCellLen;
   scaledlen.y = Dpmta_PV2Mag / Dpmta_MaxCellLen;
   scaledlen.z = Dpmta_PV3Mag / Dpmta_MaxCellLen;
