	...
	double *wa, int *ifac)
{
    ...
    /* Local variables */
    static int idot, i;
    extern /* Subroutine */ int passf(int *, int *, int *, 
	    int *, int *, double *, double *, double *, 
	    double *, double *, double *);
    static int k1, l1, l2, n2;
    extern /* Subroutine */ int passf2(int *, int *, double *, 
	    double *, double *), passf3(int *, int *, 
	    double *, double *, double *, double *), passf4(
	    int *, int *, double *, double *, double *, 
	    double *, double *), passf5(int *, int *, 
