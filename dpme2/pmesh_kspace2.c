...
/* heap or stack allocation. */
    ...
    *sizstack = *siz_q + *siztheta * 6 + *sizffwrk + *numatoms * 3;
    printf("total HEAP storage needed = %ld \n",(long int)(*sizheap));
    printf("total STACK storage needed = %ld \n",(long int)(*sizstack));
    return 0;
...
int get_scaled_fractionals2( int *numatoms,int *atompnt,int *list, double *tmpcg,
