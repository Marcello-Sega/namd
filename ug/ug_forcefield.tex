...
\subsubsection{MARTINI Residue-Based Coarse-Grain Forcefield}
%\label{sec:martini}
...
When using MARTINI in NAMD the following configuration parameters should be set as indicated:
