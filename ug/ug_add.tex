...
two groups of atoms.  When enabled, two new terms, PAIR\_VDW and PAIR\_ELECT,
will be present in the energy output to report 
the interaction energy of the two groups.  For trajectory analysis the 
