...
Locally enhanced sampling (LES)~\cite{ROIT91,SIMM98,SIMM00}
...
two groups of atoms.  When enabled, the reported VDW and ELECT energies will
correspond to the interaction energy of the two groups.  The recommended
way to use this set of options is to use the NAMD Tcl scripting 
