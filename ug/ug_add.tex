...
\item
\NAMDCONFWDEF{minimization}{Perform energy minimization?}{{\tt on} or {\tt off}}{{\tt off}}
...
position}{non-negative integer}{{\tt firstTimestep}}
...
movement {\tt SMDDir}. The new direction will come from the vertex of
...
direction}{{\tt gaussian}, {\tt uniform}}{{\tt uniform}}
...
steer your simulation.  \NAMD\ will wait for \VMD\ to connect on startup.

\begin{itemize}
\item
\NAMDCONFWDEF{IMDon}{is IMD active?}{{\tt on} or {\tt off}}{{\tt off}}
{Specifies whether or not to expect and wait for a connection.}
...
\NAMD\ will wait for a connection on this port.
