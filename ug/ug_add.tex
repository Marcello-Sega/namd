...
{\tt PAIR INTERACTION: STEP: {\it step} FORCE: {\it fx fy fz} 
...
within group 1.  Note that the reported force is incorrect and should be
ignored; by definition the total force within a group is zero.  
}
