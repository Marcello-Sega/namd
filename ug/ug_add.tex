...
or updated between runs by using the "measure consForceConfig" command.
}
...
components of the virial for each slab are recorded in the \NAMD\ output file.
...
timestep, followed by the three diagonal components of the virial in the first
