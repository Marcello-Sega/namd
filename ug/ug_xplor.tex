...
every \verb!stepspercycle! timesteps.}
...
thus only positive values of \verb!NBXMod! have \NAMD\ equivalents.  
These equivalences are
\begin{itemize}
\item
\verb!NBXMod=1! is equivalent to \verb!exclude=none! 
--- no atom pairs excluded, 
\item
\verb!NBXMod=2! is equivalent to \verb!exclude=1-2! 
--- only 1-2 pairs excluded, 
\item
\verb!NBXMod=3! is equivalent to \verb!exclude=1-3! 
--- 1-2 and 1-3 pairs excluded, 
\item
\verb!NBXMod=4! is equivalent to \verb!exclude=1-4! 
--- 1-2, 1-3, and 1-4 pairs excluded, 
\item
\verb!NBXMod!=5 is equivalent to \verb!exclude=scaled1-4! 
