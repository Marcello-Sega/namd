...
\item
\NAMDCONFWDEF{accelMDOn}{Is accelerated molecular dynamics active?}{{\tt on} or {\tt
off}}{{\tt off}}
...
\item
\NAMDCONFWDEF{accelMDskip}{Do not perform aMD for the first accelMDskip steps}
{Zero or positive integer}{0}
{aMD will not be performed for the first few steps specified by {\tt accelMDskip}. Regular MD will be performed in these steps.
}
