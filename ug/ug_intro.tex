...
%       $Revision: 1.12 $      $Date: 2000/09/18 19:52:27 $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION:
...
\subsubsection*{First Port to Windows NT}
...
\subsubsection*{Parallel PME Reciprocal Sum}
...
\subsubsection*{FFTW in Shipping Binaries}
...
\subsubsection*{Conjugate Gradient Minimizer}
...
\subsubsection*{Improved Load Balancer}
