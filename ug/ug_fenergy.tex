...
\subsubsection{Lambda control for automated MCTI}
...
\subsubsection{Bound specifications}
...
\subsubsection{Gradient for position restraint}
...
\paragraph*{for atom B moving, atoms A, C, \& D fixed}
