...
\subsubsection{Pair list generation}
...
\item
\NAMDCONF{rigidBonds}{controls if and how ShakeH is used}{\verb!none!,
...
\item
\NAMDCONF{rigidTolerance}{allowable bond-length error for ShakeH (\AA)}%
...
\item
\NAMDCONF{rigidIterations}{maximum ShakeH iterations}{positive integer}{100}%
{
...
\item
\NAMDCONFWDEF{MTSAlgorithm}{MTS algorithm to be used}{\verb!naive!, \verb!verletI!, \verb!verletX!}{\verb!naive!}
...
\item
\NAMDCONFWDEF{longSplitting}{how should long and short range forces be split?}{\verb!sharp!, \verb!xplor!, \verb!c1!}{\verb!sharp!}
