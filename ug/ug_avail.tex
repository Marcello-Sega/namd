...
%       $Revision: 1.6 $      $Date: 2001/02/23 00:52:00 $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION:
...
%
% $Log: ug_avail.tex,v $
% Revision 1.6  2001/02/23 00:52:00  jim
...
\item Scyld Beowulf on Intel and Alpha processors 
\item Solaris on Sparc processors 
\item Tru64 Unix on Alpha processors 
\item Cray T3E 
\item IBM RS/6000 SP 
\item Compaq AlphaServer SC (with MPI and Elan)
