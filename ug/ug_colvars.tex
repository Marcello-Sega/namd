...
functionality of the older \texttt{freeEnergy} module for free energy of
...
\emph{Note: restrictions only apply to the type of an individual
...
\item %
  \NAMDCONFWDEF{%
    ...
    function (default: $t$~= 0).  Note: the value at $t$~= 0 is always
