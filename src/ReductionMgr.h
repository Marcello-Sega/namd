...
typedef enum
{
 // energy
  ...
  REDUCTION_ANGLE_ENERGY_F,
  REDUCTION_ANGLE_ENERGY_TI_1,
  REDUCTION_ANGLE_ENERGY_TI_2,
  REDUCTION_BOND_ENERGY,
  REDUCTION_BOND_ENERGY_F,
  REDUCTION_BOND_ENERGY_TI_1,
  REDUCTION_BOND_ENERGY_TI_2,
  REDUCTION_DIHEDRAL_ENERGY,
  REDUCTION_DIHEDRAL_ENERGY_F,
  REDUCTION_DIHEDRAL_ENERGY_TI_1,
  REDUCTION_DIHEDRAL_ENERGY_TI_2,
  ...
  REDUCTION_IMPROPER_ENERGY_F,
  REDUCTION_IMPROPER_ENERGY_TI_1,
  REDUCTION_IMPROPER_ENERGY_TI_2,
