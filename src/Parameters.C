...
static char ident[] = "@(#)$Header: /home/cvs/namd/cvsroot/namd2/src/Parameters.C,v 1.1004 1997/04/07 14:54:33 nealk Exp $";
...
{
	Real *a1, *a2, *a3, *a4;        //  Temporary arrays for 
					//  sending messages
	int *i1, *i2;			//  Temporary int array
	int i, j;			//  Loop counters
	Real **kvals;			//  Force constant values for
					//  dihedrals and impropers
	int **nvals;			//  Periodicity values for
					//  dihedrals and impropers
	Real **deltavals;		//  Phase shift values for
					//  dihedrals and impropers
	Message *msg=new Message;	//  Message to broadcast
	if ( msg == NULL )
	{
	...
	if (NumVdwPairParams)
	{
		...
		msg->put(NumVdwPairParams, i1).put(NumVdwPairParams, i2).put(NumVdwPairParams, a1);
		msg->put(NumVdwPairParams, a2).put(NumVdwPairParams, a3).put(NumVdwPairParams, a4);
	}
...
void Parameters::receive_Parameters(Message *msg)

{
	int i, j;			//  Loop counters
	Real *a1, *a2, *a3, *a4;	//  Temporary Real arrays to get data
					//  from message in
	int *i1, *i2;			//  Temporary int array to get
					//  data from message in
 ...
 *	$Revision: 1.1004 $	$Date: 1997/04/07 14:54:33 $
 *
 ***************************************************************************
 * REVISION HISTORY:
 *
