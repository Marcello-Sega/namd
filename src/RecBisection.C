...
int RecBisection::partition(int *dest_arr)
{
    ...
    top_partition.corner.x  = patchMap->xDimension()-1;
    top_partition.corner.y  = patchMap->yDimension()-1;
    top_partition.corner.z  = patchMap->zDimension()-1;
 ...
 *	$Revision: 1.4 $	$Date: 1998/10/24 19:57:55 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
 ...
 * Revision 1.4  1998/10/24 19:57:55  jim
