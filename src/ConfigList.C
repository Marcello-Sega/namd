 ...
 * Initial revision
 *
 * Revision 1.11  1995/11/11 17:24:27  dalke
 * added a
 *   keyword {
 * this is a line
 ...
 * each time.
 *
 * Revision 1.10  95/10/07  01:50:02  01:50:02  hazen (Brett Hazen)
 * Memory Allocation error-checking added
 * 
 * Revision 1.9  1995/06/20  10:36:15  nelson
 * Fixed bug where delete [] was causing core dump on SGI's
 *
 * Revision 1.8  95/04/10  11:28:11  11:28:11  nelson (Mark T. Nelson)
 * Added include of strlib for AIX to resolve strcasecmp and strncasecmp
 * 
 * Revision 1.7  95/04/04  18:44:56  18:44:56  dalke (Andrew Dalke)
 * fixed const references
 * 
 * Revision 1.6  1995/03/08  14:46:26  nelson
 * Added copyright
 *
 * Revision 1.5  94/11/01  21:51:29  21:51:29  dalke (Andrew Dalke)
 * Fixed a delete problem
 * 
 * Revision 1.4  94/07/07  16:54:13  16:54:13  dalke (Andrew Dalke)
 * Now I close the input file.
 * 
 * Revision 1.3  94/07/07  16:45:35  16:45:35  dalke (Andrew Dalke)
 * Config can now be read from stdin with the filename '-'
 * 
 * Revision 1.2  94/07/07  19:04:01  19:04:01  dalke (Andrew Dalke)
 * Fixed bug in find_key_word
 * 
 * Revision 1.1  1994/06/27  20:45:41  dalke
 * Initial revision
 *
 ***************************************************************************/
