 ...
 *	$Revision: 1.1000 $	$Date: 1997/02/06 15:59:38 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
static char ident[] = "@(#)$Header: /home/cvs/namd/cvsroot/namd2/src/strlib.C,v 1.1000 1997/02/06 15:59:38 ari Exp $";
...
void NAMD_pad(char *str, int length)
